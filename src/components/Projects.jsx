            ...
            <a
              ...
              <div className="flex relative">
                <div className="px-8 py-10 relative z-10 w-full rounded-xl shadow-lg hover:shadow-xl cursor-pointer bg-secondary-light dark:bg-ternary-dark text-ternary-dark dark:text-ternary-light">
                  ...
                  <a href={project.source_code_link} lassName="sm:w-1/2 w-100 p-4">
                    <button className="items-center my-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Go To Website</button>
                  </a>
                </div>
              </div>
            </a>
